...
| `Nix`            | `nix search <paket>`    | `nix-env -i <paket>`    | `nix-env -u <paket>`   | `nix -e <paket>`          |
...
- Chocolatey Paket Yöneticisi komutlar: https://gist.github.com/yunga/ https://docs.chocolatey.org/en-us/choco/commands/upgrade https://docs.chocolatey.org/en-us/choco/commands/uninstall
